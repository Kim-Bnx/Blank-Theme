...
<form action="{S_POST_ACTION}" method="post" name="post" enctype="multipart/form-data">
    ...
    <div class="container">
        ...
        <!-- Post preview (template: posting_topic_review ) -->
        {POST_PREVIEW_BOX}

        <!----------------------------------------------->
        <!-- FORUM CATEGORY RULES (if applicable) -------------->
...
<!----------------------------------------------->
<!-- POST HISTORY -------------->
<!-- (template: posting_topic_review (posts) // privmsg_topic_review (private messages)-->

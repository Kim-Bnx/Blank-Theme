  ...
  <div id="cp-main" class="ucp-main">
    <form action="{S_PROFILE_ACTION}" {S_FORM_ENCTYPE} method="post" name="post" id="ucp">
      ...
      <div class="panel">
        ...
        <fieldset>
          ...
          <dl>
            ...
            <dd><input type="hidden" name="username" value="{USERNAME}" class="inputbox" /><strong>{USERNAME}</strong>
            </dd>
          </dl>
      ...
      <div class="panel" style="overflow: visible">
        <div id="list_awards" style="width: 100%; text-align: center">
          {switch_informations_menu.switch_awards.AWARDS_LIST}</div>

        <center>
          <input id="awards_order" type="hidden" name="awards_order" value="" />
          <input style="cursor: pointer" id="sort_awards" class="button1" type="button" name="order"
            value="{switch_informations_menu.switch_awards.L_SORT}" />
        </center>
      </div>
      ...
      <div class="panel">
        <fieldset>
          <dl>
            ...
            <dd>
              <a href="{switch_informations_menu.rgpd_generate_or_download.RGPD_ACTION_LINK}"
                class="button1">{switch_informations_menu.rgpd_generate_or_download.RGPD_ACTION_CONTENT}</a>
              <br /><br />
      ...
      <div class="panel">
        <fieldset>
          <dl>
            ...
            <dd><input type="password" name="new_password" value="{NEW_PASSWORD}" class="inputbox" maxlength="25" />
            </dd>
          </dl>
          <dl>
            <dt><label>{L_CONFIRM_PASSWORD}&nbsp;: *</label></dt>
            <dd>
              <input type="password" name="password_confirm" value="{PASSWORD_CONFIRM}" class="inputbox"
                maxlength="25" />
        ...
        <fieldset>
          <dl>
            ...
            <dd>
              ...
              <!-- BEGIN switch_enable_mail_view --><label><input type="radio" name="viewemail" value="2"
                  {VIEW_EMAIL_FORM} />{L_FORM}</label>
              <label><input type="radio" name="viewemail" value="1" {VIEW_EMAIL_MAILTO} />{L_MAILTO}</label>
              <!-- END switch_enable_mail_view --><label><input type="radio" name="viewemail" value="0"
                  {VIEW_EMAIL_NO} />{L_NO}</label>
            </dd>
          </dl>
          ...
          <dl>
            ...
            <dd>
              <label><input type="radio" name="profilemsgs" value="2"
                  {switch_preferences_menu.switch_profile_advanced.PROFILE_MSGS_ALL} />{L_ALL_USERS}</label> &nbsp;
              <label><input type="radio" name="profilemsgs" value="1"
                  {switch_preferences_menu.switch_profile_advanced.PROFILE_MSGS_FRIENDS} />{L_MY_FRIENDS}</label> &nbsp;
              <label><input type="radio" name="profilemsgs" value="0"
                  {switch_preferences_menu.switch_profile_advanced.PROFILE_MSGS_NONE} />{L_NO_ONE}</label> &nbsp;
              <label><input type="radio" name="profilemsgs" value="-1"
                  {switch_preferences_menu.switch_profile_advanced.PROFILE_MSGS_HIDE} />{L_HIDE_TAB}</label>
            </dd>
          </dl>
          ...
          <dl>
            ...
            <dd>
              ...
              <label><input type="radio" name="allow_mass_pm" value="0"
                  {DISABLE_MASS_PM_CHECKED} />{L_NO_MASS_PM}</label>
          ...
          <dl>
            ...
            <dd>
              <label><input type="radio" name="notify_subscriptions" value="1"
                  {NOTIFY_SUBSCRIPTIONS_YES} />{L_YES}</label>
              <label><input type="radio" name="notify_subscriptions" value="0"
                  {NOTIFY_SUBSCRIPTIONS_NO} />{L_NO}</label>
            </dd>
          </dl>
          ...
          <dl>
            ...
            <dd>
              <label><input type="radio" name="no_report_popup" value="0"
                  {switch_preferences_menu.switch_report.NO_REPORT_POPUP_YES} />{L_YES}</label>
              <label><input type="radio" name="no_report_popup" value="1"
                  {switch_preferences_menu.switch_report.NO_REPORT_POPUP_NO} />{L_NO}</label>
            </dd>
          </dl>
          <!-- END switch_report -->
          ...
          <dl>
            ...
            <dd>
              <label><input type="radio" name="attachsig" value="1"
                  {switch_preferences_menu.switch_signature.ALWAYS_ADD_SIGNATURE_YES} />{L_YES}</label>
              <label><input type="radio" name="attachsig" value="0"
                  {switch_preferences_menu.switch_signature.ALWAYS_ADD_SIGNATURE_NO} />{L_NO}</label>
            </dd>
          </dl>
        ...
        <fieldset>
          <dl>
            <dt>
              ...
              <span class="italic">{L_AVATAR_EXPLAIN}</span>
            </dt>
            <dd>
              {AVATAR}
      ...
      <fieldset class="submit-buttons">
        <center>
          {S_HIDDEN_FIELDS}
          <input class="primary" type="submit" name="submit" value="{L_SUBMIT}" />&nbsp;

<details class="panel">
  <summary>
    <h3 style="display: inline">{L_ADD_A_POLL}</h3>
  </summary>
  <fieldset>
    <dl>
    ...
    <dl>
      ...
      <dd><textarea name="poll_option_text" rows="{POLL_OPTION_NUMBER}" cols="40"
          class="inputbox">{POLL_OPTIONS}</textarea></dd>
    </dl>
    ...
    <dl>
      ...
      <dd>
        <input type="text" name="poll_option_text[{poll_option_rows.S_POLL_OPTION_NUM}]" class="inputbox"
          maxlength="255" value="{poll_option_rows.POLL_OPTION}" />
    ...
    <dl>
      ...
      <dd>
        <label><input type="radio" name="poll_cancel_vote" value="1" {POLL_CANCEL_VOTE_AUTHORIZED_STATUS} />
          {L_YES}</label>
        <label><input type="radio" name="poll_cancel_vote" value="0" {POLL_CANCEL_VOTE_UNAUTHORIZED_STATUS} />
          {L_NO}</label>
      </dd>
    </dl>
    ...
    <dl>
      ...
      <dd>
        <label><input type="radio" name="poll_public_members" value="1"
            {switch_poll_public.POLL_DISPLAY_MEMBERS_CHECK} /> {L_YES}</label>
        <label><input type="radio" name="poll_public_members" value="0"
            {switch_poll_public.POLL_DISPLAY_MEMBERS_UNCHECK} /> {L_NO}</label>
      </dd>
    </dl>
    ...
    <dl>
      ...
      <dd>
        <label><input type="radio" name="poll_public_whovoted" value="2"
            {switch_poll_public.switch_poll_whovoted.POLL_DISPLAY_WHOVOTED_CHECK_TIME} />
          {switch_poll_public.switch_poll_whovoted.L_TIMED_REVEAL}</label>
        <label><input type="radio" name="poll_public_whovoted" value="1"
            {switch_poll_public.switch_poll_whovoted.POLL_DISPLAY_WHOVOTED_CHECK} /> {L_YES}</label>
        <label><input type="radio" name="poll_public_whovoted" value="0"
            {switch_poll_public.switch_poll_whovoted.POLL_DISPLAY_WHOVOTED_UNCHECK} /> {L_NO}</label>
      </dd>
    </dl>

...
if('{QUOTE_PM_IMG}') { quoteBtn ? quoteBtn.href = '/privmsg?mode=quote&p=' + post : null } else {quoteBtn.remove();}

const editBtn = document.querySelector('a[href="/privmsg?mode=edit"]');
if('{EDIT_PM_IMG}') { editBtn ? editBtn.href = '/privmsg?mode=edit&p=' + post : null } else {editBtn.remove();}
</script>

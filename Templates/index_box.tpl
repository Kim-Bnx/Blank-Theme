...
<!-- BEGIN tablehead -->
<div class="categorie" id="{catrow.tablehead.ID}">
...
<!-- END tablehead -->
        ...
        <div class="forum_row">
            ...
            <div class="forum_details">
                ...
                <!-- Liens de sous-forum -->
                <span id="ssforum">{catrow.forumrow.L_LINKS}{catrow.forumrow.LINKS}</span>

                <!-- Compteur sujets et message -->
                <span class="forum_stats">{catrow.forumrow.TOPICS} sujets et {catrow.forumrow.POSTS} messages</span>
            </div>
...
<!-- Suprresion des virgules entre les liens de sous-forum -->
<script type="text/javascript">document.getElementById('ssforum').innerHTML=document.getElementById ('ssforum').innerHTML.replace(/, /," ");</script>
